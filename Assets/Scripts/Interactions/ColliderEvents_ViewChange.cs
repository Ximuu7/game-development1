...
public class ColliderEvents_ViewChange : MonoBehaviour
{
    private SpriteOutline outlineController;
    private Coroutine currentOutlineCoroutine;
    private Interaction_ViewChange viewChange;

    void Awake()
    {
        outlineController = GetComponent<SpriteOutline>();
        GameObject obj = GameObject.Find("Interaction_ViewChange");
        viewChange = obj.GetComponent<Interaction_ViewChange>();
